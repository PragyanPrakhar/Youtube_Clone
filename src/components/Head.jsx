...
const Head = () => {
    ...
    // const [querySend,setQuerySend]=useState("");
...
//     // Watch for changes to searchQuery and navigate to the desired route
//     useEffect(() => {
//         if (searchQuery) {
//             navigate("/watchpage/?search=" + searchQuery);
//         }
...
//         // Set the selected suggestion in the search query
//         setSearchQuery(suggestion);
//         setShowSuggestions(false);
//     };
